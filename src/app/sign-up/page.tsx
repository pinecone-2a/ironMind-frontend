...
export default function UsernameSignup({ onSubmit, onClick }: { onSubmit: (username: string) => void; onClick: () => void; }) {
  ...
  const handleSubmit = (data: z.infer<typeof formSchema>) => {
    ...
    return(
      ...
      <div className=" flex flex-col items-start">
       ...
       <button
         className="bg-[#F4F4F5] px-5 py-3 rounded-md text-[14px] absolute top-10 right-0">Log In</button>
      </div>
      </div>
    )
  }