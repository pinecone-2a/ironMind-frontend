...
export default function DonationScreen() {
  ...
  return (
    <div className="w-[628px] rounded-md border p-5 bg-white">
      ...
      <p className="text-[14px] mt-6 mb-2">
      ...
      <input
        ...
        className="border rounded-md px-3 py-2 w-[100%] text-[14px] h-[25%] flex items-start"
      ></input>

      <button className="py-2 bg-[#18181B] flex justify-center items-center w-[100%] text-white mt-8 rounded-md hover:bg-[#616164] text-[14px]">
        Support
      </button>
    </div>
  );
